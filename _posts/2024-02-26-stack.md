...
I register all my domains mainly from the following websites - not much difference while NameCheap is cheaper with additional features. The DNS servers are then changed to SiteGround (see below) to use company name and CMS.

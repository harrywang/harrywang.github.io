...
Update (3/4/2022): After the website's recent update, the script on EC2 will be detected as a bot and then fail the reCAPTCHA test. Running the script locally using the Firefox driver can pass the test for now.

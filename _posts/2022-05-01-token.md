...
by issuing 1 million ERC20 tokens on Ethereum (or Polygon) with gas estimation and contract verification.
...
Then run the following with the your deployed contract address:

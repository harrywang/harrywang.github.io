...
I somehow got interested in I Ching and bought a copy of the following book (see the bio of [Richard Wilhelm 卫礼贤](https://schoolofwisdom.com/about/richard-wilhelm-one-of-the-school-of-wisdoms-most-notable-teachers/)).

<img class="mx-auto" width="400" src="{{site.baseurl}}/assets/img/posts/iching/wilhelm.jpg">

<img class="mx-auto" width="400"  src="{{site.baseurl}}/assets/img/posts/iching/my-copy.jpg">

I especially enjoyed reading the [Foreword by Carl Gustav Jung 荣格](https://www.iging.com/intro/foreword.htm).

Then, I learned [how to consult the I Ching Oracle](https://www.youtube.com/watch?v=KgXaIYpAEHQ) using the three-coins approach.

I wrote a Python program for this: [Ask I Ching using Python](https://gist.github.com/harrywang/b0441cd5d8e47cf6cb9e115ad32b41b7).

All 64 hexagrams are made of the following two types of lines:

- `- -` is called the dark line
- `---` is called the light line

The three-coins approach also needs the transformation lines:

- `- - .` is called the dark line transformation
- `--- .` is called the light line transformation

Toss the three coins with a question in mind. 

Head is 3, Tail is 2 and the formula is as follows:

- 3 + 3 + 2 = 8 is `- -`
- 2 + 2 + 3 = 7 is `---`
- 2 + 2 + 2 = 6 is `- - .` which is transformed to `---`
- 3 + 3 + 3 = 9 is `--- .` which is transformed to `- -`

Each toss you get one line, repeat 6 times and you get the hexagram for your question. 

You then can read the meaning of the hexagram below and try to interpret the result. 

I created the Markdown version of the 64 Hexagrams based on the [Full I Ching Text by Richard Wilhelm](http://www2.unipr.it/~deyoung/I_Ching_Wilhelm_Translation.html). I originally posted this in this [repo](https://github.com/harrywang/iching-book).


### Trigrams

<img class="mx-auto" width="400" src="{{site.baseurl}}/assets/img/posts/iching/trigrams.png">

Source: wikipedia.com

### Sequence Chart

<img class="mx-auto" width="400" src="{{site.baseurl}}/assets/img/posts/iching/sequence-chart.jpg">

Source: inthefamilyway.org

### Chinese Pinyin Pronunciation

<img class="mx-auto" width="400" src="{{site.baseurl}}/assets/img/posts/iching/pinyin.jpg">

Source: baidu.com

### 64 Hexagrams

<img class="mx-auto" width="400" src="{{site.baseurl}}/assets/img/posts/iching/en-ch-1.jpg">
<img class="mx-auto" width="400" src="{{site.baseurl}}/assets/img/posts/iching/en-ch-2.jpg">

Source: zhihu.com

I created a [csv file]({{site.baseurl}}/assets/files/iching-hexagrams.csv) for the 64 Hexagrams.

...
This tutorial shows how to deploy DeepSeek with [Ollama](https://ollama.com/), [LiteLLM](https://www.litellm.ai/), and [OpenWebUI](https://github.com/open-webui/open-webui) on Ubuntu 24.10. Optional steps are provided to set up with [Ngrok](https://ngrok.com/).

Many thanks to my Ph.D. student Chenchuan He for helping test and debug the deployment on our server.
...
Then, you can pull and run `deepseek-r1:7b` with: 
...
If you want to run LiteLLM in the background, redirect both stdout and stderr to `litellm.log`:

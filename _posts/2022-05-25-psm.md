...
If we plot `revenue` with `starting_date`, we can see that the date is highly correlated with treatment:

<img class="mx-auto" src="https://user-images.githubusercontent.com/595772/170391325-f0e6f5a3-f567-4add-9cb4-fd47323369fe.png">

if `starting_date` is used to calculate the propensity score, there is only little overlap resulting in not enough matched observations:
